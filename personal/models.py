...
class FamilyMemo(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True, verbose_name="작성일시")
...
class PersonalSchedule(models.Model):
    ...
    schedule_start_time = models.DateTimeField(verbose_name="개인 스케줄 시작 시간")
    schedule_end_time = models.DateTimeField(verbose_name="개인 스케줄 종료 시간")
